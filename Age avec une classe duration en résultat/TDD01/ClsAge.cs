...
namespace Time
{
    ...
    public static class ClsAge
    {
        ...
        public static Duration GetAge(DateTime pBeginDate, DateTime pEndDate)
        {
            ...
            Duration age = new Duration(ageYear, ageMonth, ageDays);
        ...
        public static Duration GetAge(DateTime dateTime)
        {
